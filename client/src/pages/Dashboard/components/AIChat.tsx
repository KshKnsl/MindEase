...
export default function AIChat() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-xl overflow-hidden border border-purple-100 h-[400px] max-w-md w-full">
      ...
      <form onSubmit={handleSubmit} className="p-3 border-t bg-white flex items-center space-x-2">
        <input
          type="text"
        ...
        />
        {userInput && (
          <Button type="submit" size="icon" variant="default" className="rounded-full bg-purple-600">
        ...
        <div className="relative">
          <Button
            ...
            className={`rounded-full ${isListening ? 'bg-red-500' : 'bg-purple-600'}`}
          ...
          {isListening && (
            <motion.div 
              className="absolute -inset-2 rounded-full border-2 border-red-400 opacity-75"
              animate={{
                scale: [1, 1.3, 1],
                opacity: [0.7, 0.2, 0.7]
              }}
